...
namespace O21HDPawns
{
    public class HDPawnsMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listing.CheckboxEnhanced("Slim Rim", "Slim Rim allows control over which body types are allowed to exist, if you disable a body type below it'll convert pawns automatically to Male or Female depending on their gender. Default is for this only to affect fat pawns, hence the name. (Requires game restart to change this option)", ref settings.slimRim);
            ...
            listing.CheckboxEnhanced("Thin", "Ok maybe that's a little too thin...", ref settings.slimRim_thin);
            listing.End();
